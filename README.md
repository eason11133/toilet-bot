...
除了搜尋功能，本專案也包含使用者回饋、狀態回報、使用分析、服務缺口分析，以及供管理者維護公共設施資料的 CivicFix 工作台。
...
| 資料維護者 | 使用 CivicFix 同步資料、建立問題工單、審核使用者投稿並發布修正 |
...
| `/dashboard/civicfix` | CivicFix 資料維護工作台 |
